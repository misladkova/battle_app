    ...
    return(
        <div>
            ...
            <form onSubmit={handleCreate}>
                ...
                <button class="btn btn-primary mr-1 mt-2 mb-2" id="create-button" type="submit">add</button>
                <button class="btn btn-secondary mt-2 mb-2" onClick={() => setCreateVisible(false)}>cancel</button>
            </form>
        </div>
    )
}
