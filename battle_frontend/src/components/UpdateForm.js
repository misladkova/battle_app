    ...
    return(
        <div>
            ...
            <form onSubmit={handleChange}>
                ...
                <button class="btn btn-primary mr-1 mt-2 mb-2" id="update-button">change</button> <button class="btn btn-secondary mt-2 mb-2" onClick={() => setUpdateVisible(false)}>cancel</button>
            </form>
        </div>
    )
}
